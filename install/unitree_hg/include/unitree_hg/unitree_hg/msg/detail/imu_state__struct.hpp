...
#ifndef UNITREE_HG__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
#define UNITREE_HG__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__unitree_hg__msg__IMUState __attribute__((deprecated))
#else
# define DEPRECATED__unitree_hg__msg__IMUState __declspec(deprecated)
#endif
...
struct IMUState_
{
  ...
  using ConstRawPtr =
    const unitree_hg::msg::IMUState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<unitree_hg::msg::IMUState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<unitree_hg::msg::IMUState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      unitree_hg::msg::IMUState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<unitree_hg::msg::IMUState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<unitree_hg::msg::IMUState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<unitree_hg::msg::IMUState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<unitree_hg::msg::IMUState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__unitree_hg__msg__IMUState
    std::shared_ptr<unitree_hg::msg::IMUState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__unitree_hg__msg__IMUState
    std::shared_ptr<unitree_hg::msg::IMUState_<ContainerAllocator> const>
...
using IMUState =
  unitree_hg::msg::IMUState_<std::allocator<void>>;
...
#endif  // UNITREE_HG__MSG__DETAIL__IMU_STATE__STRUCT_HPP_
