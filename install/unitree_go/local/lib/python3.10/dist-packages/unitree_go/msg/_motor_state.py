...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def q_raw(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'q_raw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._q_raw = value
    ...
    def dq_raw(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'dq_raw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._dq_raw = value
    ...
    def ddq_raw(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'ddq_raw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._ddq_raw = value
