...
class UwbState(metaclass=Metaclass_UwbState):
    ...
    def __init__(self, **kwargs):
        ...
        if 'joystick' not in kwargs:
            ...
            self.joystick = kwargs.get('joystick')
    ...
    def __eq__(self, other):
        ...
        if self.base_yaw != other.base_yaw:
            return False
        if any(self.joystick != other.joystick):
            return False
    ...
    def orientation_est(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'orientation_est' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def pitch_est(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'pitch_est' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def distance_est(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'distance_est' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def yaw_est(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'yaw_est' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._yaw_est = value
    ...
    def tag_roll(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tag_roll' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def tag_pitch(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tag_pitch' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def tag_yaw(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'tag_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._tag_yaw = value
    ...
    def base_roll(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'base_roll' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def base_pitch(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'base_pitch' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def base_yaw(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'base_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def joystick(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'joystick' field must be a set or sequence with length 2 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
