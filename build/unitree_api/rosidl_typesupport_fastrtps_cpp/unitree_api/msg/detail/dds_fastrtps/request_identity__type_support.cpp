...
#include "unitree_api/msg/detail/request_identity__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_api::msg::RequestIdentity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_api::msg::RequestIdentity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_api::msg::RequestIdentity *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RequestIdentity__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const unitree_api::msg::RequestIdentity *>(
...
static size_t _RequestIdentity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RequestIdentity(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RequestIdentity__callbacks = {
  "unitree_api::msg",
  "RequestIdentity",
...
static rosidl_message_type_support_t _RequestIdentity__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RequestIdentity__callbacks,
...
get_message_type_support_handle<unitree_api::msg::RequestIdentity>()
{
  return &unitree_api::msg::typesupport_fastrtps_cpp::_RequestIdentity__handle;
}
