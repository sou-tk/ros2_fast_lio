...
#include "unitree_go/msg/detail/bms_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const unitree_go::msg::BmsCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unitree_go::msg::BmsCmd & ros_message)
{
  // Member: off
  cdr >> ros_message.off;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_go::msg::BmsCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unitree_go::msg::BmsCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_go::msg::BmsCmd *>(
    untyped_ros_message);
...
static size_t _BmsCmd__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_BmsCmd(full_bounded, is_plain, 0);
...
get_message_type_support_handle<unitree_go::msg::BmsCmd>()
{
  return &unitree_go::msg::typesupport_fastrtps_cpp::_BmsCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_go, msg, BmsCmd)() {
  return &unitree_go::msg::typesupport_fastrtps_cpp::_BmsCmd__handle;
}
