...
#include "unitree_go/msg/detail/motor_states__rosidl_typesupport_fastrtps_c.h"
...
#include "unitree_go/msg/detail/motor_state__functions.h"  // states
...
using _MotorStates__ros_msg_type = unitree_go__msg__MotorStates;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      unitree_go__msg__MotorState__Sequence__fini(&ros_message->states);
    }
...
size_t get_serialized_size_unitree_go__msg__MotorStates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorStates__ros_msg_type * ros_message = static_cast<const _MotorStates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MotorStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_go__msg__MotorStates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_go
size_t max_serialized_size_unitree_go__msg__MotorStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_go__msg__MotorStates;
    is_plain =
      (
...
static size_t _MotorStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_go__msg__MotorStates(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_go, msg, MotorStates)() {
