...
class IMUState(metaclass=Metaclass_IMUState):
    ...
    def __eq__(self, other):
        ...
        if any(self.quaternion != other.quaternion):
            return False
        if any(self.gyroscope != other.gyroscope):
            return False
        if any(self.accelerometer != other.accelerometer):
            return False
