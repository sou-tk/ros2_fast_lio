...
class LowState(metaclass=Metaclass_LowState):
    ...
    def __init__(self, **kwargs):
        ...
        if 'foot_force_est' not in kwargs:
            ...
            self.foot_force_est = kwargs.get('foot_force_est')
        ...
        if 'fan_frequency' not in kwargs:
            ...
            self.fan_frequency = kwargs.get('fan_frequency')
    ...
    def __eq__(self, other):
        ...
        if any(self.foot_force != other.foot_force):
            return False
        if any(self.foot_force_est != other.foot_force_est):
            return False
        ...
        if self.power_a != other.power_a:
            return False
        if any(self.fan_frequency != other.fan_frequency):
            return False
    ...
    def adc_reel(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'adc_reel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
