...
class LidarState(metaclass=Metaclass_LidarState):
    ...
    def __init__(self, **kwargs):
        ...
        if 'imu_rpy' not in kwargs:
            ...
            self.imu_rpy = kwargs.get('imu_rpy')
    ...
    def __eq__(self, other):
        ...
        if self.imu_packet_loss_rate != other.imu_packet_loss_rate:
            return False
        if any(self.imu_rpy != other.imu_rpy):
            return False
    ...
    def sys_rotation_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'sys_rotation_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def com_rotation_speed(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'com_rotation_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def cloud_frequency(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cloud_frequency' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def cloud_packet_loss_rate(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'cloud_packet_loss_rate' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def imu_frequency(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'imu_frequency' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def imu_packet_loss_rate(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'imu_packet_loss_rate' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def imu_rpy(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'imu_rpy' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
    ...
    def serial_recv_stamp(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'serial_recv_stamp' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
