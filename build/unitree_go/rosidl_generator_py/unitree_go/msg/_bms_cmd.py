...
class Metaclass_BmsCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__bms_cmd
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__bms_cmd
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__bms_cmd
            cls._TYPE_SUPPORT = module.type_support_msg__msg__bms_cmd
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__bms_cmd
...
class BmsCmd(metaclass=Metaclass_BmsCmd):
    ...
    def __init__(self, **kwargs):
        ...
        if 'reserve' not in kwargs:
            self.reserve = numpy.zeros(3, dtype=numpy.uint8)
        else:
    ...
    def reserve(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'reserve' field must be a set or sequence with length 3 and each value of type 'int' and each unsigned integer in [0, 255]"
